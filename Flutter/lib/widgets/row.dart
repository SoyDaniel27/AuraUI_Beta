...
class AuraRow extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    final flex = 12/data['columns']; //Obtener el flex de la division 12/(Numero de columnas)
    final slots = data['slots']; //Obtener los slots del Row
    return Row(
        ...
        Expanded(
          ...
          child: Padding(padding: const EdgeInsets.all(10.0),
            child: Container(
              ...
              child: Center( //Contenido centrado
